        ...
        return {
            ...
            link: function (scope, element, attrs) {
                ...
                function setDivider() {
                    ...
                    var type = scope.feed[scope.currentTopic].topic;
                    var prevItem = scope.feed[scope.currentTopic].items[scope.currentItem-1];
                ...
                function insertTemplate() {
                    ...
                    switch (scope.feed[scope.currentTopic].topic) {
						...
						console.log("in insert template");
							tickerPrimary.html(getNewsTemplate());
                            break;
                    }
